[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=docker-compose_compose&metric=alert_status)](https://sonarcloud.io/dashboard?id=docker-compose_compose)
